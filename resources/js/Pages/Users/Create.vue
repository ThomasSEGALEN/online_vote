...
// import FirstStep from "./Partials/FirstCreateForm.vue";
// import SecondStep from "./Partials/SecondCreateForm.vue";

defineProps(["civilities", "roles", "groups"]);

const { message } = usePage().props?.flash; //as any;
...
const nextPage = () => {
    form.post(route("users.store"), {
        onSuccess: () => {
            const permissions = (usePage().props?.data) /* as any*/.permissions;
        ...
        <div class="max-w-4xl mx-auto py-12 px-8">
            <div class="bg-white shadow-sm rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form @submit.prevent="submit">
                        <div v-if="formStep === 1">
                            ...
                            <div class="flex mt-4 justify-end">
                                <SecondaryButton @click="nextPage">
                                    Suivant
                                </SecondaryButton>
                            </div>
                        </div>
                    ...
                    >
                        <p
                            v-if="form.recentlySuccessful && message"
                    ...
                    <!-- <FirstStep
                        v-if="form.formStep === 1"
                        :form="form"
                        :civilities="props.civilities"
                        :roles="props.roles"
                        :groups="props.groups"
                    /> -->

                    <!-- <SecondStep v-if="form.formStep === 2" :form="form" /> -->
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
